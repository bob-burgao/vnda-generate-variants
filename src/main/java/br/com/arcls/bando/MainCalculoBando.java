...
public class MainCalculoBando {
    ...
    public static BigDecimal custoTotal(QuestionsData questionsData, Integer largura) {
        ...
        if(larguraBD.compareTo(larguraMinima) < 0) {
            larguraBD = larguraMinima;
        }

        BigDecimal materiaPrima =  custoTotal.add(questionsData.getMateriaPrima().multiply(larguraBD));
