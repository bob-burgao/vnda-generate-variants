...
import br.com.arcls.area.QuestionsData;
...
public class Communs {
    ...
    public static List<List<String[]>> getLinhas(QuestionsData questionsData) {
        ...
        while (larguraBase <= questionsData.getAreaMax()) {
            linhas.add(new String[]{
                    ...
                    "1", //peso
                    String.valueOf(larguraBase), //largura - 10 que será o tamanho maximo do pacote
    ...
    public static String getPreco(QuestionsData questionsData, int largura, int altura) {
        BigDecimal custoTotal = Communs.custoTotal(questionsData, largura, altura);
